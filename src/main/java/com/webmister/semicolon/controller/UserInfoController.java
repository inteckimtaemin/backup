...
public class UserInfoController {
    ...
    public ResponseEntity<Boolean> signUp(@RequestBody UserInfoRequest userInfoRequest) {
        ...
        try {
        if ( userInfoService.checkDupicateUserNickname(userInfoRequest.getUserNickName()) == false)
            if(userInfoService.checkDupicateEmail(userInfoRequest.getUserEmail()) == false)
